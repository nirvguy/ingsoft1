...
class SimuladorAutenticador(object):
    def __init__(self):
        self._usuario = None
...
class TestInterfaz(unittest.TestCase):
    def setUp(self):
        self._autenticador = SimuladorAutenticador()

    def test01_create_cart_autentica_usuario(self):
        ...
        self.assertEqual(self._autenticador.usuario(), CLIENTE)
        self.assertEqual(self._autenticador.contrasenia(), CONTRASENIA)

    def test02_list_purchases_autentica_usuario(self):
        interfaz = InterfazRest(self._autenticador, CATALOGO_DE_UN_ELEMENTO, RELOJ_ESTACIONARIO, MP)
        id_carrito = interfaz.list_purchases(CLIENTE, CONTRASENIA)
        self.assertEqual(self._autenticador.usuario(), CLIENTE)
        self.assertEqual(self._autenticador.contrasenia(), CONTRASENIA)

    def test03_al_crear_un_carrito_vacio_la_lista_de_productos_del_carrito_debe_ser_vacia(self):
        interfaz = InterfazRest(self._autenticador, CATALOGO_DE_UN_ELEMENTO, RELOJ_ESTACIONARIO, MP)
    ...
    def test16_al_hacer_checkout_de_multiples_productos_estos_figuran_comprados(self):
        interfaz = InterfazRest(self._autenticador, CATALOGO_DE_MULTIPLES_ELEMENTOS, RELOJ_ESTACIONARIO, MP)
    ...
    def test22_no_se_puede_agregar_a_un_carrito_despues_de_31_minutos_de_inactividad(self):
        reloj = RelojMovil()
        interfaz = InterfazRest(self._autenticador, CATALOGO_DE_MULTIPLES_ELEMENTOS, reloj, MP)
